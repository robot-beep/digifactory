  ...
  return (
    ...
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Contáctanos por lo siguientes medios
      </h3>
      <p className="mb-11 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Telefono: +569 97387257
        correo: contacto@digifactory.cl
      </p>
